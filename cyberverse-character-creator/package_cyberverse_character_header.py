...
html = (
    ...
    # ── Outer wrapper — no card chrome, icon-led row on transparent bg ──
    ...
    'background:$3;box-shadow:0 0 20px -3px $3;"></div>'

    # Content layer (octagon, inset to fake a clipped border)
    '<div style="position:absolute;inset:2.2px;overflow:hidden;'
    'clip-path:polygon(20% 0,80% 0,100% 20%,100% 80%,80% 100%,20% 100%,0 80%,0 20%);'
    'background:#05060a;">'
    ...
    '<svg viewBox="0 0 24 24" width="42" height="42" fill="none" stroke="$3" '
    'stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" style="opacity:.8;">'
    ...
    'border-top:2px solid $3;border-left:2px solid $3;opacity:.85;pointer-events:none;"></div>'
    '<div style="position:absolute;top:-4px;right:-4px;width:12px;height:12px;'
    'border-top:2px solid $3;border-right:2px solid $3;opacity:.85;pointer-events:none;"></div>'
    '<div style="position:absolute;bottom:-4px;left:-4px;width:12px;height:12px;'
    'border-bottom:2px solid $3;border-left:2px solid $3;opacity:.85;pointer-events:none;"></div>'
    '<div style="position:absolute;bottom:-4px;right:-4px;width:12px;height:12px;'
    'border-bottom:2px solid $3;border-right:2px solid $3;opacity:.85;pointer-events:none;"></div>'

    # Online status dot
    '<div style="position:absolute;bottom:2px;left:2px;width:13px;height:13px;border-radius:50%;z-index:10;'
    'background:#39ff8a;border:2px solid #05060a;box-shadow:0 0 8px 1px rgba(57,255,138,.7);"></div>'

    # Chip badge — top-right corner
    '<div style="position:absolute;top:-6px;right:-6px;z-index:10;width:22px;height:22px;'
    'border-radius:4px;background:$3;display:flex;align-items:center;justify-content:center;'
    'box-shadow:0 0 10px -1px $3;">'
    ...
    # Name
    "<span style=\"font-family:'Orbitron',sans-serif;font-size:17px;font-weight:700;"
    'color:#eafcff;letter-spacing:1px;text-transform:uppercase;'
    'white-space:nowrap;overflow:hidden;text-overflow:ellipsis;'
    'text-shadow:0 0 16px -2px $3;">$2</span>'

    # Subtitle row — monospace HUD tag, no pill/kanji
    '<div style="display:flex;align-items:center;gap:7px;">'
    '<span style="height:1px;width:24px;background:linear-gradient(90deg,$3,transparent);flex-shrink:0;"></span>'
    "<span style=\"font-family:'Share Tech Mono',monospace;font-size:9px;letter-spacing:2.2px;"
